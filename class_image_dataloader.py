...
class ClassImageDataLoader(VisionDataset):
    """
    ...
    def get_dataset_paths(self):
        ...
        Returns
        -------
        train_image_paths: List of strings for the paths of train images
        test_image_paths: List of strings for the paths of test images
        validation_image_paths: List of strings for the paths of validation images
        """
        imagepaths = []
